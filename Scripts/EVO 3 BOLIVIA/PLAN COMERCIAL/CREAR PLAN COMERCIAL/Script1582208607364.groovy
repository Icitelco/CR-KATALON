...
WebUI.setText(findTestObject('Object Repository/Page_Plan Comercial/input_Nombre_W0027W0007W0009PLANCOMERCIALNOMBRE'), ' PLAN COMERCIAL MANCHESTERR')

//SEGMENTO DE CLIENTES AL QUE PERMITE AGRERARSE
...
//NOMBRE DEL PLAN QUE CREAMOS
WebUI.setText(findTestObject('Object Repository/Page_Planes Comerciales/input_Nombre_vPLANCOMERCIALNOMBRE'), ' PLAN COMERCIAL MANCHESTERR')
...
//NOMBRE DE LA LINEA DEL ARTICULO (SIN MUCHA IMPORTANCIA)
...
//NOMBRE DEL PRODUCTO QUE SE AGREGA AL PLAN
...
//FECHA DE INICIO DE LA VIGENCIA DEL PLAN
...
//FECHA DE FIN DE LA VIGENCIA DEL PLAN
...
//NOMBRE DE LA VIGENCIA (SIN IMPORTANCIA)
