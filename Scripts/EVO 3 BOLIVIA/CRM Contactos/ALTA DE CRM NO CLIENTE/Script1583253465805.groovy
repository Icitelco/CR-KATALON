...
WebUI.click(findTestObject('Object Repository/Page_Registro de CRM Inicial/form_adminADMINISTRADORGestin ComercialClie_e07d3d'))

WebUI.click(findTestObject('Object Repository/Page_Registro de CRM Inicial/input_Es Cliente_vE_ESCLIENTE'))

WebUI.click(findTestObject('Page_Registro de CRM Inicial/input_     0000_ACCIONINICIAR'))
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Registro de CRM Inicial/select_(Ninguno)PENDIENTEFINALIZADOANULADOC_aca55c'), 
    'F', true)
