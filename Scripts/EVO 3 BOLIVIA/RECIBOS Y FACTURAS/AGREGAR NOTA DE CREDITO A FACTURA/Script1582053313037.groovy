...
WebUI.click(findTestObject('Object Repository/Page_Cliente/input_UltVisualizacin_W0029W0007vCREARNC_0001'))

WebUI.click(findTestObject('Object Repository/Page_Cliente/input_NC Importe_vE_SEL_0001'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Cliente/select_(Ninguno)CARGO GENERADO CAMBIO PLANE_420481'), 
    '458', true)

WebUI.click(findTestObject('Object Repository/Page_Cliente/input_INSTALACION DECO PRE-PAGO_GENERARNC'))

WebUI.click(findTestObject('Object Repository/Page_Cliente/button_Aceptar (1)'))
