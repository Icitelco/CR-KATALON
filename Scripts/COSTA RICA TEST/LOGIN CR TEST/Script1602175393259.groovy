...
WebUI.navigateToUrl('http://10.7.57.126/SIGA-MSA-TG/servlet/login')

WebUI.setText(findTestObject('Object Repository/Page_Login/input_Nombre de usuario_vUSUARIO'), 'MARCAUZ')

WebUI.setEncryptedText(findTestObject('Login/Page_Login/input_Contrasea_vPASSWORD'), 'AWdMazKUyn+GySLH4PESGA==')
