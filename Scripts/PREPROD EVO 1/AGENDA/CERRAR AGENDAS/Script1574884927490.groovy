...
WebUI.click(findTestObject('Object Repository/Page_Agendas/input_Hasta Fecha_allbox'))

WebUI.click(findTestObject('Object Repository/Page_Agendas/input_Agendas_CERRARABRIR'))
