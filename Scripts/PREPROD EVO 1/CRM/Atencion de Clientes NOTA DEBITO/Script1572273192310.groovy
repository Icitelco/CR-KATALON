...
WebUI.click(findTestObject('Object Repository/Page_Registro de CRM - 360/input_Impuesto_vE_SEL_0001 (1)'))

WebUI.click(findTestObject('Object Repository/Page_Registro de CRM - 360/input_IMPUESTO_GENERARNOTA'))

WebUI.takeScreenshot()

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/Page_Registro de CRM - 360/button_Aceptar (1)'))
