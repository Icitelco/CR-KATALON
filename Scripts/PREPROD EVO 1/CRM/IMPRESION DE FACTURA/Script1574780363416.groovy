...
WebUI.click(findTestObject('Object Repository/Page_Registro de CRM - 360/input_Envio Fac_IMPRIMIRFACTURA'))

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Page_Registro de CRM - 360/img_CA Tipo_vE_IMPRIMEFACTURA_0001'))
