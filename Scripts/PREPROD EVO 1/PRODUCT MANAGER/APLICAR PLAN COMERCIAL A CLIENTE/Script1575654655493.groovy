...
WebUI.setText(findTestObject('Object Repository/Page_Cliente/input_Nombre_W0030W0008W0007CLIENTENOM'), 'Prueba PlanComercial')
...
WebUI.setText(findTestObject('Object Repository/Page_Ingreso de Contratos/input_Nombre_vE_FILTROPLANCOMERCIALNOMBRE (1)'), 
    'PLAN PRUEBA')

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/Page_Ingreso de Contratos/input_Nombre_BUSCAR (1)'))
...
WebUI.click(findTestObject('Object Repository/Page_Ingreso de Contratos/a_PLAN PRUEBA (1)'))

WebUI.delay(5)

WebUI.takeScreenshot()

WebUI.click(findTestObject('Object Repository/Page_Ingreso de Contratos/input_PLAN PRUEBA_SELECCIONAR (1)'))
...
WebUI.click(findTestObject('Object Repository/Page_PRUEBA PLANCOMERCIAL PRUEBA/a_27412003'))

WebUI.click(findTestObject('Object Repository/Page_PRUEBA PLANCOMERCIAL PRUEBA/a_27412004'))
