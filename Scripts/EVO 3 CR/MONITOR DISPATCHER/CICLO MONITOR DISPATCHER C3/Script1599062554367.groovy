...
WebUI.click(findTestObject('COSTA RICA/input_DESCONEXIONES CONSOLIDADO_C3'))

WebUI.click(findTestObject('Page_Monitor Orden Agendamiento((Dispatcher)))/span_ABONADO RECHAZA'))

WebUI.setText(findTestObject('Page_Monitor Orden Agendamiento((Dispatcher)))/textarea_ABONADO RECHAZA- - - Observaciones_542218'), 
    'Pruebaaaaaaaaaaaaa')

WebUI.scrollToElement(findTestObject('Object Repository/COSTA RICA/ARREGLOS DISPATCHER/Page_Monitor Orden Agendamiento(Dispatcher)/input_RESULTADO_BTNCONFIRMAR'), 
    20)

WebUI.click(findTestObject('Object Repository/COSTA RICA/ARREGLOS DISPATCHER/Page_Monitor Orden Agendamiento(Dispatcher)/input_RESULTADO_BTNCONFIRMAR'))

WebUI.scrollToElement(findTestObject('Object Repository/COSTA RICA/ARREGLOS DISPATCHER/Page_Monitor Orden Agendamiento(Dispatcher)/input_Confirma cancelar las ordenes_BTNCONF_bdce44'), 
    20)

WebUI.click(findTestObject('Object Repository/COSTA RICA/ARREGLOS DISPATCHER/Page_Monitor Orden Agendamiento(Dispatcher)/input_Confirma cancelar las ordenes_BTNCONF_bdce44'))
