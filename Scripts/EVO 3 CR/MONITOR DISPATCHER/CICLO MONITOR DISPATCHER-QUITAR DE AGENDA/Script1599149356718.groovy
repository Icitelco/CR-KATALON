...
String Agendanro = WebUI.getText(findTestObject('Page_Monitor Orden Agendamiento((Dispatcher)))/a_9831851'))

CustomKeywords.'CRPERP_ACTUALIZAR_ORDENES_POR_AGENDANRO_A_AGENDADA.CRPREP_Cliente_Numero'(Agendanro)

WebUI.click(findTestObject('Page_Monitor Orden Agendamiento(Dispatcher))/input_DESCONEXIONES CONSOLIDADO_W0038vBTNAGE_0001'))

WebUI.selectOptionByValue(findTestObject('Page_Monitor Orden Agendamiento(Dispatcher))/select_(Ninguno)Agendamiento incorrectament_b40c8f'), 
    '1', true)

WebUI.click(findTestObject('Page_Monitor Orden Agendamiento(Dispatcher))/input_Actualmente_QUITARDEAGENDA'))
