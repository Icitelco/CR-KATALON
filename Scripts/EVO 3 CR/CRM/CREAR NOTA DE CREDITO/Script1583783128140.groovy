...
WebUI.click(findTestObject('COSTA RICA/input_Nota de Cred_NOTADECREDITO'))

WebUI.click(findTestObject('Object Repository/Page_Registro de CRM - 360/input_PAGA_vE_CREARNOTA_0001'))

WebUI.delay(6)

WebUI.setText(findTestObject('COSTA RICA/input_Motivo Detalle_vE_PROMPTDETALLE'), '132')

WebUI.click(findTestObject('Object Repository/Page_Registro de CRM - 360/input_Impuesto_vE_SEL_0001'))

WebUI.click(findTestObject('COSTA RICA/input_IMPUESTO_GENERARNOTA - Copy'))
