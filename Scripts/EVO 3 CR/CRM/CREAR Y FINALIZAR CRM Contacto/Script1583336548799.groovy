...
WebUI.click(findTestObject('Page_Registro de CRM de Usuario/input_MARCAUZ_ALTAWP'))

WebUI.setText(findTestObject('Page_Registro de CRM - 360/input_Cliente Nro_vE_CLIENTENRO'), '18')

WebUI.click(findTestObject('Page_Registro de CRM - 360/input_BANCO_BUSCAR'))

WebUI.click(findTestObject('Page_Registro de CRM - 360/span_Mensaje_gxp0_cls'))

WebUI.click(findTestObject('Page_Registro de CRM - 360/input_     0000_ACCIONINICIAR'))
...
WebUI.selectOptionByValue(findTestObject('Page_Registro de CRM - 360/select_(Ninguno)BBIBBIFLCONSULTADIGDTHFLGES_ab6f79'), 
    '1', true)
...
WebUI.click(findTestObject('Page_Registro de CRM - 360/input_Inicio_ACCIONFINALIZAR'))

WebUI.click(findTestObject('Page_Registro de CRM - 360/button_Aceptar'))

WebUI.setText(findTestObject('Object Repository/Page_Registro de CRM de Usuario/input_CRM Nro_vCRMNRO'), a)

WebUI.click(findTestObject('Page_Registro de CRM de Usuario/input_Motivo_SEARCHBUTTON'))
