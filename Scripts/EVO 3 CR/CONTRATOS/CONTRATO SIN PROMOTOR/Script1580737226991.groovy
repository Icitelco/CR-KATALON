...
WebUI.click(findTestObject('Page_Ingreso de Contratos/input_DevicePrdId_ELEGIRPRODUCTOS'))

WebUI.delay(10)

WebUI.setText(findTestObject('Page_Ingreso de Contratos/input_Nombre_vPRODUCTONOMBRE'), 'INTERNET RESIDENCIAL 10 MEGAS')

WebUI.delay(5)

WebUI.click(findTestObject('Page_Ingreso de Contratos/input_Aprovisionar_vSELECCIONADO_0001'))

WebUI.click(findTestObject('Object Repository/Page_Ingreso de Contratos/input__CONFIRMAR'))

WebUI.selectOptionByValue(findTestObject('Page_Ingreso de Contratos por Cambio de Producto/select_(Ninguno)INTERNET HOGAR 50 MEGASINTE_71e5ec'), 
    '5239', true)
