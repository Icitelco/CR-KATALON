...
String CLIENTE = CustomKeywords.'CRPREP_CLIENTE_INGRESADO_DTH.CRPREP_Cliente_Numero'()
...
if (CLIENTE == null) {
    ...
    WebUI.callTestCase(findTestCase('EVO 3 CR/CREAR CLIENTES/4.CLIENTE DTH'), [:])

    WebUI.closeBrowser()

    WebUI.callTestCase(findTestCase('EVO 3 CR/CONTRATOS/CONTRATO CLIENTE DTH'), [:])
} else {
    ...
    WebUI.setText(findTestObject('Object Repository/Page_Ingreso de Contratos/input_Nombre_vPRODUCTONOMBRE'), 'DTH BASICO')
    ...
    WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Ingreso de Contratos/select_(Ninguno)PLAN DTH BASICO'), 
        '6611', true)
