...
String CLIENTE = CustomKeywords.'CRPREP_CLIENTE_INGRESADO_COORPORATIVO.CRPREP_Cliente_Numero'()
...
if (CLIENTE == null) {
    ...
    WebUI.callTestCase(findTestCase('EVO 3 CR/CREAR CLIENTES/2.CLIENTE CORPORATIVO'), [:])

    WebUI.closeBrowser()

    WebUI.callTestCase(findTestCase('EVO 3 CR/CONTRATOS/CONTRATO CLIENTE CORPORATIVO'), [:])
} else {
    ...
    WebUI.setText(findTestObject('Object Repository/Page_Ingreso de Contratos/input_Nombre_vPRODUCTONOMBRE (1)'), 'SERVICIO BASICO')
    ...
    WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Ingreso de Contratos/select_(Ninguno)BASIC- CORP-- SERVICIO BASI_5f2ebd'), 
        '670', true)
