...
if (ClienteNro == null) {
    ...
    WebUI.waitForElementPresent(findTestObject('Object Repository/Page_Despliega formulario y archivos/div_Acciones_hvr-icon-finalizaretapa'), 
        30)
    ...
    WebUI.click(findTestObject('Object Repository/Page_Despliega formulario y archivos/input_Acciones_vBTNSUSPENDER (1)'))
    ...
    WebUI.click(findTestObject('Object Repository/Page_Menu Principal de Tramite/input_GRUPO SUSPENSIONDIGITACION PYMES  B2B_14364c (2)'))

    WebUI.click(findTestObject('Object Repository/Page_Despliega formulario y archivos/input_Acciones_vBTNENPROCESO (1)'))
