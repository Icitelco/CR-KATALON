...
CLIENTENRO = CustomKeywords.'CRPREP_CLIENTE_CON_2017_SERVICIO_DIGITAL.CRPREP_Cliente_Numero'()
...
WebUI.click(findTestObject('Object Repository/Page_Clientes/a_NICOLAS'))
