...
WebUI.click(findTestObject('Page_CLIENTE APELLIDO-A/span_Contratos'))
...
WebUI.click(findTestObject('Page_CLIENTE APELLIDO-A/span_Servicios'))

WebUI.click(findTestObject('Page_CLIENTE APELLIDO-A/input_Histricos_W0033W0007AGREGARSERVICIO'))

WebUI.selectOptionByValue(findTestObject('Page_Ingreso de Servicio de Clientee/select_NingunoCOBRO ARTICULOS NO RECUPERABL_6fe62f'), 
    '5', true)
...
WebUI.click(findTestObject('Page_Ingreso de Servicio de Clientee/input_Contrato_vE_PROMPTCONTRATO'))

WebUI.setText(findTestObject('Page_Ingreso de Servicio de Clientee/input_Producto_vPRODUCTONOMBRE'), 'INTERNET RESIDENCIAL 25 MEGAS')

WebUI.delay(5)

WebUI.click(findTestObject('Page_Ingreso de Servicio de Clientee/a_INTERNET RESIDENCIAL 25 MEGAS'))

WebUI.delay(20)

WebUI.selectOptionByValue(findTestObject('Page_Ingreso de Servicio de Clientee/select_(Ninguno)INTERNET 1MB COVIDINTERNET _1e49dc'), 
    '1463', true)
