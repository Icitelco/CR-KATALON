...
WebUI.selectOptionByValue(findTestObject('Object Repository/select_CORPORATIVODTHFONATELHOMEPYMESSEGMEN_a20c43'), '1', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/select_CONDOMINIO HOME RESIDENCIALCORTESIA _d34f6f'), '114', 
    true)

WebUI.selectOptionByValue(findTestObject('Object Repository/select_1 CLIENTES HFC11 OPS202012 CLIENTES _1bd73a'), '418', 
    true)
