...
String Clientenro = CustomKeywords.'CRPRERP_CLIENTE_CON_RECIBO_CHEQUE.CRPREP_Cliente_Numero'()
...
String ReciboNro = CustomKeywords.'CRPRERP_RECIBO_CHEQUE_DE_CLIENTE.CRPREP_Cliente_Numero'(Clientenro)
...
String ChequeNro = CustomKeywords.'CRPRERP_CHEQUENRO.CRPREP_Cliente_Numero'(ReciboNro)
