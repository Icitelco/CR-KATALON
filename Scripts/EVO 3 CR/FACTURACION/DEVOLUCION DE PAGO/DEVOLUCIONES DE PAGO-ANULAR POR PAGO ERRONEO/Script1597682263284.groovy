...
String Clientenro = CustomKeywords.'CRPRERP_CLIENTE_CON_RECIBO_SALDO.CRPREP_Cliente_Numero'()
...
String ReciboNro = CustomKeywords.'CRPRERP_RECIBO_CON_SALDO_DE_CLIENTE.CRPREP_Cliente_Numero'(Clientenro)
