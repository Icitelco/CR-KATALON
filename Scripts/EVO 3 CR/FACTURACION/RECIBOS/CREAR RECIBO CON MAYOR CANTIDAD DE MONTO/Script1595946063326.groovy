...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_Ingresar Recibo de Pago - CC/span_100000'), 0)

String Monto = WebUI.getText(findTestObject('Object Repository/Page_Ingresar Recibo de Pago - CC/span_100000'))

String Monto1 = '1'.concat(Monto)
