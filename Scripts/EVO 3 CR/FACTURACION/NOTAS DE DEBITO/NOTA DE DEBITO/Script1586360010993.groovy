...
WebUI.click(findTestObject('Object Repository/Page_Cliente/input_Es de Gobierno_W0033W0007vCREARND_0001'))

WebUI.setText(findTestObject('COSTA RICA/input_Motivo Detalle_vE_PROMPTDETALLE'), '122')
...
WebUI.click(findTestObject('COSTA RICA/SELECCIONAR CONCEPTO'))

//WebUI.click(findTestObject('Page_CLIENTE APELLIDO-A/input_IMPUESTO_GENERARNC'))

WebUI.click(findTestObject('COSTA RICA/input_IMPUESTO_GENERARNOTA'))
