...
public class CRPRERP_POLITICAPRODUCTO {
	@Keyword
	def CRPREP_Cliente_Numero(String Producto){
		...
		String query="select POLITICAID FROM SIGATG.PRODUCTOPOL WHERE PRODUCTOID=".concat(Producto)
