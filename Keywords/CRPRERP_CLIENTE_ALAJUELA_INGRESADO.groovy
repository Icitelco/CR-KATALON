...
public class CRPRERP_CLIENTE_ALAJUELA_INGRESADO {
	@Keyword
	def CRPREP_Cliente_Numero(){
		...
		String query="SELECT MAX(CLIENTENRO) FROM SIGATG.CLIENTE WHERE CLIENTESTS='I' AND CIUDADID=2 AND NEGOCIOSEGMENTO=1"
