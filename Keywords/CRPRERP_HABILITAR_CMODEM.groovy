...
public class CRPRERP_HABILITAR_CMODEM {
	@Keyword
	def CRPREP_Cliente_Numero(String art){
		...
		String query="UPDATE CMODEM SET CMODEMHAB=1 WHERE CMODEMID=".concat("'").concat(art).concat("'")
