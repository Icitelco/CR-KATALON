...
public class CRPREP_PRODUCTO_INTERNET_RESIDENCIAL {
	@Keyword
	def CRPREP_Cliente_Numero(){
		...
		String query="SELECT PRODUCTOID FROM SIGATG.PRODUCTO WHERE PRODUCTONOMBRE='INTERNET RESIDENCIAL 10 MEGAS'"
