...
public class CRPERP_ACTUALIZAR_ORDENES_POR_AGENDANRO_A_AGENDADA {
	@Keyword
	def CRPREP_Cliente_Numero(String Agendanro){
		...
		String query="UPDATE ORDENSRV SET ORDENSTS='A' WHERE ORDENAGENDANRO=".concat(Agendanro)
