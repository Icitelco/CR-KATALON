...
public class CRPREP_CONTRATO_CON_PROMOCIONN {
	@Keyword
	def CRPREP_Cliente_Numero(){
		...
		String query="SELECT MAX(CONTRATONRO) FROM SIGATG.CONTRATOPROMOCION WHERE PROMOCIONID IN (SELECT MAX(PROMOCIONID) FROM SIGATG.PROMOCION)"
