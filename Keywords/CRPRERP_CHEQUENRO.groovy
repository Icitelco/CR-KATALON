...
public class CRPRERP_CHEQUENRO {
	@Keyword
	def CRPREP_Cliente_Numero(String ReciboNro){
		...
		String query="SELECT RBOCPGODOCNRO FROM RECIBOLINEA WHERE RECIBONRO=".concat(ReciboNro)
