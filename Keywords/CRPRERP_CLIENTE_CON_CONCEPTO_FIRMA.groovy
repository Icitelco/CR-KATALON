...
public class CRPRERP_CLIENTE_CON_CONCEPTO_FIRMA {
	@Keyword
	def CRPREP_Cliente_Numero(){
		...
		String query="SELECT MAX(CLIENTENRO) FROM FACTURAPENDIENTE FAC WHERE FACTURAPENDTPO='W' AND FACTURAPENDSTS='L'"
