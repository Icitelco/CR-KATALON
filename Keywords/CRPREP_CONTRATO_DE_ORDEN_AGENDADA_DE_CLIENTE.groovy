...
public class CRPREP_CONTRATO_DE_ORDEN_AGENDADA_DE_CLIENTE {
	@Keyword
	def CRPREP_Cliente_Numero(String clientenroord){
		...
		String query="SELECT CONTRATONRO FROM SIGATG.ORDENSRV WHERE ORDENSTS='A' AND ORDENTPO='R' AND CLIENTENROORD=".concat(clientenroord)
