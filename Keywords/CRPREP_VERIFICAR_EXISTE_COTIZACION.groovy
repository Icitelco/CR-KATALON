...
public class CRPREP_VERIFICAR_EXISTE_COTIZACION {
	@Keyword
	def CRPREP_Cliente_Numero(String fecha){
		...
		String query="SELECT MONEDAFCH FROM SIGATG.MONEDACOTIZA WHERE MONEDAFCH=TO_DATE(".concat("'").concat(fecha).concat("'").concat(",").concat("'DD/MM/RRRR").concat("'").concat(")")
