...
public class CRPREP_PRODUCTO_INTERNET_RESIDENCIAL_3_MEGAS_NUEVO {
	@Keyword
	def CRPREP_Producto_ID(){
		...
		String query="SELECT PRODUCTOID FROM SIGATG.PRODUCTO WHERE PRODUCTONOMBRE='INTERNET RESIDENCIAL 3 MEGAS NUEVO"
