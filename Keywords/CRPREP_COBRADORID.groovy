...
public class CRPREP_COBRADORID {
	@Keyword
	def CRPREP_Cliente_Numero(String CobradorNombre){
		...
		String query="SELECT COBRADORID FROM SIGATG.COBRADOR WHERE COBRADORNOMBRE=".concat("'").concat(CobradorNombre).concat("'")
