...
public class CRPREP_CLIENTE_CONECTADO_SIN_COMPROBANTES_PARA_AUTORIZARR {
	@Keyword
	def CRPREP_Cliente_Numero(){
		...
		String query="SELECT MAX(CLIENTENRO) FROM SIGATG.CLIENTE WHERE CLIENTESTS='C' AND CLIENTENRO NOT IN (SELECT CLIENTENRO FROM SIGATG.CMPTEAUTORIZAR WHERE CMPTEAUTORIZARSTS='P')"
