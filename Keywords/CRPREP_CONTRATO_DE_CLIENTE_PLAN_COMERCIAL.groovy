...
public class CRPREP_CONTRATO_DE_CLIENTE_PLAN_COMERCIAL {
	@Keyword
	def CRPREP_Cliente_Numero(String Clientenro){
		...
		String query="SELECT MAX (CONTRATONRO) FROM SIGATG.CONTRATO WHERE CONTRATOSTS='C' AND PLANCOMERCIALCLIENTEID<>0 AND CONTRATOORINRO=0 and CLIENTENRO=".concat(Clientenro)
