...
public class CRPREP_NOMBRE_MAXTECNICOO {
	@Keyword
	def CRPREP_Cliente_Numero(){
		...
		String query="SELECT TECNICONOMBRE FROM SIGATG.TECNICO WHERE TECNICOID IN (select max(tecnicoid)from sigatg.tecnico)"
