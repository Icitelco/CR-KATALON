...
public class CRPREP_FECHA_AGENDA_ALEJUELA_ACTIVA {
	@Keyword
	def CRPREP_Cliente_Numero(){
		...
		String query="SELECT TO_CHAR(MAX(AGENDAFECHA), 'dd/mm/yyyy') FROM AGENDA WHERE CENTROOPERATIVOID='2' AND TAREATIPOID='201' AND AGENDASTS='A'"
