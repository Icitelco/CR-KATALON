...
public class CRPRERP_PROMOCIONID_NOMBRE {
	@Keyword
	def CRPREP_Cliente_Numero(){
		...
		String query="SELECT PROMOCIONNOMBRE FROM SIGATG.PROMOCION WHERE PROMOCIONID IN (SELECT MAX(PROMOCIONID) FROM SIGATG.PROMOCION)"
