...
public class CRPREP_ORDEN_FECHA_DE_ORDEN_AGENDADA_DE_CLIENTE {
	@Keyword
	def CRPREP_Cliente_Numero(String clientenroord,String Contratonro){
		...
		String query="SELECT TO_CHAR(ORDENFING,'DD/MM/RRRR')FROM SIGATG.ORDENSRV WHERE ORDENSTS='A' AND ORDENTPO='R' AND CLIENTENROORD=".concat(clientenroord).concat("AND CONTRATONRO=").concat(Contratonro)
