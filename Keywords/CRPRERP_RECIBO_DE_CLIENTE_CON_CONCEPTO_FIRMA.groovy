...
public class CRPRERP_RECIBO_DE_CLIENTE_CON_CONCEPTO_FIRMA {
	@Keyword
	def CRPREP_Cliente_Numero(String Clientenro){
		...
		String query="SELECT MAX(FACTURAPENDRECIBONRO) FROM FACTURAPENDIENTE FAC WHERE FACTURAPENDTPO='W' AND FACTURAPENDSTS='L' AND CLIENTENRO=".concat(Clientenro)
