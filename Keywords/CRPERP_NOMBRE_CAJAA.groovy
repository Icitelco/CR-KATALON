...
public class CRPERP_NOMBRE_CAJAA {
	@Keyword
	def CRPREP_Cliente_Numero(){
		...
		String query="SELECT CAJANOMBRE FROM SIGATG.CAJA WHERE CAJANRO IN (SELECT MAX(CAJANRO) FROM SIGATG.CAJA WHERE CAJAGRUPOID=8)"
