...
public class CRPREP_PROMOCIONGENERALNOMBREEE {
	@Keyword
	def CRPREP_Cliente_Numero(){
		...
		String query="SELECT PROMOCIONGRLNOMBRE FROM SIGATG.PROMOCIONGRL WHERE PROMOCIONGRLID IN (SELECT MAX(PROMOCIONGRLID) FROM SIGATG.PROMOCIONGRL)"
