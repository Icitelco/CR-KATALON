...
public class CRPREP_ELIMINAR_COBRADOR_Y_CAJA {
	@Keyword
	def CRPREP_Cliente_Numero(String CobradorID){
		...
		String query="DELETE FROM SIGATG.CAJACOBRADOR WHERE COBRADORID=".concat(CobradorID)
