...
public class CRPRERP_ARTICULO_CABLEMODEM {
	@Keyword
	def CRPREP_Cliente_Numero(){
		...
		String query="SELECT MAX(ARTICULOID) FROM SIGATG.ARTICULO WHERE ARTICULOAPROVISIONAR='C' AND ARTICULOID IN (SELECT ARTICULOID FROM ARTICULOSERIE WHERE ARTICULOSTS='T')"
