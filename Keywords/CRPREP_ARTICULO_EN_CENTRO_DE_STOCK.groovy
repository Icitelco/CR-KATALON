...
public class CRPREP_ARTICULO_EN_CENTRO_DE_STOCK {
	@Keyword
	def CRPREP_Cliente_Numero(){
		...
		String query="SELECT TRIM(MAX(ARTICULOSERIE)) FROM ARTICULOSERIE AR WHERE ARTICULOID=249 AND CENTROSTKID=671"
