...
public class CRPRERP_CLIENTE_CON_PLAN_COMERCIAL {
	@Keyword
	def CRPREP_Cliente_Numero(){
		...
		String query="SELECT MAX(CLIENTENRO) FROM SIGATG.CONTRATO WHERE CONTRATOSTS='C' AND PLANCOMERCIALCLIENTEID<>0"
