...
public class CRPRERP_FORMULARIO_WRFLW_VERSION {
	@Keyword
	def CRPREP_Cliente_Numero(String FormularioID){
		...
		String query="SELECT FLFORMULARIOVERSION FROM SIGATG.FLFORMULARIO WHERE FLFORMULARIOID=".concat("'").concat(FormularioID).concat("'")
