...
public class CRPREP_CLIENTE_CON_INTERNET_RESIDENCIAL_4_MEGAS {
	@Keyword
	def CRPREP_Cliente_Numero(){
		...
		String query="SELECT MAX(CLIENTENRO) FROM CONTRATO WHERE PRODUCTOID=947 AND CONTRATOSTS='C' AND PLANCOMERCIALCLIENTEID<>0"
