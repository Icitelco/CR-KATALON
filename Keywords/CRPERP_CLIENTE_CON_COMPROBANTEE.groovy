...
public class CRPERP_CLIENTE_CON_COMPROBANTEE {
	@Keyword
	def CRPREP_Cliente_Numero(){
		...
		String query="select CLIENTENRO from CMPTEAUTORIZAR where CMPTEAUTORIZARNRO IN (select MAX(CMPTEAUTORIZARNRO) from CMPTEAUTORIZAR where CMPTEAUTORIZARSTS='P' AND CMPTEAUTORIZARTPO='N')"
